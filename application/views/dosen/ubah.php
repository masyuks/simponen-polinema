				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('dosen/proses_ubah/'.$dosen->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode_dosen"><strong>Nomor Induk</strong></label>
											<input type="number" name="kode_dosen" placeholder="Masukkan Nomor Induk" autocomplete="off"  class="form-control" required value="<?= $dosen->kode_dosen ?>" required>
										</div>
										<div class="form-group col-md-6">
											<label for="nama_dosen"><strong>Nama dosen</strong></label>
											<input type="text" name="nama_dosen" placeholder="Masukkan Nama dosen" autocomplete="off"  class="form-control" required value="<?= $dosen->nama_dosen ?>">
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
