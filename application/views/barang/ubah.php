								...
								<form action="<?= base_url('barang/proses_ubah/' . $barang->kode_barang) ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="number" name="harga" placeholder="Masukkan Harga" autocomplete="off"  class="form-control" required value="<?= $barang->harga ?>">
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="harga_jual"><strong>Upload Gambar</strong></label>
											<input type="file" name="image"  class="form-control">
											<span style="color: red;"><small>*Kosongi bila tidak diubah | Maks 5 Mb</small></span>
										</div>
										<div class="form-group col-md-6">
									...
									<input type="hidden" name="old_image" value="<?= $barang->path ?>">
									<hr>
